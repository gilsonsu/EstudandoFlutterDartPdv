...
class FormService extends StatefulWidget {
  //final int idd;
  //FormService({this.idd, Key key}) : super(key: key);

  final CCategory category;

  FormService({this.category ,Key key}) : super(key: key);

  @override
  _FormService createState() => _FormService();
}

class _FormService extends State<FormService> {
